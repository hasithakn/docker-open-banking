...
This section defines the step-by-step instructions to build an [alpine](https://hub.docker.com/_/alpine/) Linux based Docker image for WSO2 Open Banking API Manager UK Toolkit with WSO2 APIM 4.1.0.
